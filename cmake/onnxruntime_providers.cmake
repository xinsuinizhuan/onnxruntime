...
#  include_directories("${CMAKE_CURRENT_BINARY_DIR}/onnx")
  ...
  if (OPENVINO_VERSION VERSION_EQUAL "2020.3")
    list(APPEND OPENVINO_LIB_LIST IE::inference_engine ${NGRAPH_LIBRARIES} ${PYTHON_LIBRARIES})
  else()
    list(APPEND OPENVINO_LIB_LIST IE::inference_engine ${NGRAPH_LIBRARIES} ngraph::onnx_importer ${PYTHON_LIBRARIES})
  endif()

  if (OPENVINO_VERSION VERSION_LESS "2021.2")
	if (WIN32)
		# Add Library path
  ...
  target_include_directories(onnxruntime_providers_openvino SYSTEM PUBLIC ${ONNXRUNTIME_ROOT} ${CMAKE_CURRENT_BINARY_DIR} ${OPENVINO_INCLUDE_DIR_LIST} ${eigen_INCLUDE_DIRS} ${PYTHON_INCLUDE_DIRS})
